...
import { CATEGORIES, TransactionType, RecurringFrequency } from '@/types/finance';
...
export function RecurringTransactionSheet() {
  ...
  const { addRecurringTransaction, currency } = useFinance();
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="bottom" className="h-[90vh] rounded-t-3xl flex flex-col p-0">
        <SheetHeader className="px-6 pt-6 pb-4 shrink-0">
          <SheetTitle className="text-center text-xl">Add Recurring Transaction</SheetTitle>
        </SheetHeader>
