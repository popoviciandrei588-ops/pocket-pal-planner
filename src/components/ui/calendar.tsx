    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-10 w-10 bg-secondary/50 p-0 hover:bg-secondary hover:opacity-100 transition-colors",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-full w-full p-0 font-normal aria-selected:opacity-100 hover:bg-secondary/80 transition-colors rounded-lg"),
        ...
        day_today: "bg-accent/80 text-accent-foreground font-bold rounded-lg",
        day_outside:
