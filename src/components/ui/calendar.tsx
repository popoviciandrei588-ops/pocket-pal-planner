  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-10 w-full rounded-xl font-normal text-sm hover:bg-secondary/60 transition-colors flex items-center justify-center",
        day_range_end: "day-range-end",
        day_selected: "bg-primary text-primary-foreground hover:bg-primary font-semibold",
        day_today: "ring-2 ring-primary/50 font-bold",
